        ...
        <div class="col-md-3">
            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    ...
                    <p class="text-muted">
                        {{ date('jS F Y',strtotime($donor->created_at)) }}
                    </p>
                    ...
                    <p class="text-muted">
                        {{ date('jS F Y',strtotime($donor->user->dob)) }} , Age : {{ $donor->user->age }}
                    </p>
                    ...
                    <p class="text-muted">Permanent: {{ $donor->permanent_address }}</p>
                ...
                <div class="card-body">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="status">
                            <form class="form-horizontal" method="POST" action="{{ route('donor.status',$donor->id) }}">
                                @csrf
                                {{ method_field('PUT') }}
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control select2" name="status">
                                            <option value="1" @if($donor->status == 1) ? selected @endif>Active</option>
                                            <option value="0" @if($donor->status == 0) ? selected @endif>Inactive</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
